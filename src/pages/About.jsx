...
export default function About() {
    return (
        ...
        <div className={shell.container}>
            <div className={`${shell.whiteBlock} ${styles.whiteBlock}`}>
                <div>
                ...
                <div className={styles.infoText}>
                    ...
                    <p>
                        The sound of Nintendo, early 2010's Monstercat, and Japanese as well as Korean popular music are some of my many inspirations!
                    </p>
                    <Link className={shell.backLink} to="/">◄ Home</Link>
                </div>
            </div>
        </div>
    )
